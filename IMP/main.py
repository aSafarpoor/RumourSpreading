...
if __name__ == "__main__":
    ...
    dict_counter_measure = {'id':COUNTER_MEASURE_COMMUNITY_DETECTION, 
                            'num_green':1, 
                            'start_time':4, 
                            'green_spreading_ratio':0.5,
                            'p_orange_h':0.05, 
                            'p_orange_r':0.1, 
                            'p_coinflip':0.7, 
                            'frac_green':0.1, 
                            'threshold_detection':0.05,
                            'threshold_block':0.05}

    dict_args = {"degree_of_supernodes":150, 
                "number_of_supernodes": 1000, 
                "nodes_in_clique": 16}
    
    list_gray = BigSimulation(num_runs=1, 
                                graph_loc= fb_loc,
                                type_graph='SN', 
                                num_red=1, 
                                k=5, 
