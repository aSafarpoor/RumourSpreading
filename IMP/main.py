...
if __name__ == "__main__":
    ...
    dict_args = {"n": 1500, "tau1": 3, "tau2": 3, "mu": 0.4, "average_degree": 100,
                 "min_community": 350, "tol": 0.1, "max_iters": 1000, "seed": None}

    dict_counter_measure = {"id": COUNTER_MEASURE_COUNTER_RUMOR_SPREAD, "start_time": 15, "num_green": 50}
    ...
    [list_num_white, list_num_black, list_num_gray, list_num_green] = \
        Simulation(graph="none", SNtype=False, type_graph="LFR", num_black=1, gray_p=0,
