...
if __name__ == "__main__":
    ...
    dict_counter_measure = {"id": COUNTER_MEASURE_COMMUNITY_DETECTION, "threshold_detection": 0.1,"threshold_block":0.1}
    ...
    [list_num_white, list_num_black, list_num_gray, list_num_green] = \
        Simulation(graph="none", SNtype=False, type_graph="LFR", num_black=100, gray_p=0,
                   tresh=0.10, d=0, k=5, dict_args=dict_args, dict_counter_measure=dict_counter_measure,seed=6)
