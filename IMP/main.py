...
if __name__ == "__main__":
    ...
    dict_counter_measure = {'id':COUNTER_MEASURE_NONE, 'num_green':1, 'start_time':4, 'green_spreading_ratio':0.5,
    ...
    list_gray = BigSimulation(num_runs=1, graph_loc=musea_DE_loc, type_graph='SN', num_red=1, k=5, dict_args=dict_args,dict_counter_measure=dict_counter_measure)
